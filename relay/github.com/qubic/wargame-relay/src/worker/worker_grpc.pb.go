...
func (c *workerServiceClient) GetJob(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (*GetJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, WorkerService_GetJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var WorkerService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/worker/worker.proto",
}
